...
export const pageApi = {
  ...
  getAllForEditor: () => api.get("/users/me/conferences"),
  get: (conferenceId, pageId) =>
    api.get(`/conferences/${conferenceId}/pages/${pageId}`),
  create: (conferenceId, data) =>
    api.post(`/conferences/${conferenceId}/pages`, data),
  update: (conferenceId, pageId, data) =>
    api.put(`/conferences/${conferenceId}/pages/${pageId}`, data),
  delete: (conferenceId, pageId) =>
    api.delete(`/conferences/${conferenceId}/pages/${pageId}`),
  toggleStatus: (conferenceId, pageId, currentStatus) => {
    const newStatus = currentStatus === "published" ? "draft" : "published";
    return api.put(`/conferences/${conferenceId}/pages/${pageId}`, {
      status: newStatus,
    });
  },
  requestPublish: (conferenceId, pageId) => {
    return api.put(`/conferences/${conferenceId}/pages/${pageId}`, {
      status: "pending",
    });
  },
